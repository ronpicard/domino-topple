...
import type { GestureState, RunEvent, SceneProps } from './sceneApi.ts'
    ...
    >
      <SimContext.Provider value={simRef}>
        <GestureContext.Provider value={gestureRef}>
          ...
          <CameraRig level={level} mode={mode} cameraResetKey={cameraResetKey} reducedMotion={reducedMotion} />
